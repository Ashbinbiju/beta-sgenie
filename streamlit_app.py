...
SECTORS = {
    ...
    "IT": [
        ...
        "SONATSOFTW-EQ", "KPITTECH-EQ", "BIRLASOFT-EQ", "TATAELXSI-EQ", "MINDTREE-EQ",
        "INTELLECT-EQ", "HAPPSTMNDS-EQ", "MASTEK-EQ", "ECLERX-EQ", "NIITLTD-EQ",
        "RSYSTEMS-EQ", "OFSS-EQ", "AURIONPRO-EQ", "DATAMATICS-EQ",
        "QUICKHEAL-EQ", "CIGNITITEC-EQ", "SAGILITY-EQ", "ALLSEC-EQ"
    ],
    ...
    "Finance": [
        ...
        "L&TFH-EQ", "CREDITACC-EQ", "MANAPPURAM-EQ", "DHANI-EQ", "JMFINANCIL-EQ",
    ...
    "Pharma": [
        ...
        "LAURUSLABS-EQ", "STAR-EQ", "JUBLPHARMA-EQ", "ASTRAZEN-EQ", "WOCKPHARDT-EQ",
        "FORTIS-EQ", "MAXHEALTH-EQ", "METROPOLIS-EQ", "THYROCARE-EQ", "POLYMED-EQ",
        "KIMS-EQ", "LALPATHLAB-EQ", "MEDPLUS-EQ", "ERIS-EQ", "INDOCO-EQ",
        "CAPLIPOINT-EQ", "NEULANDLAB-EQ", "SHILPAMED-EQ", "SUVENPHAR-EQ", "AARTIDRUGS-EQ",
    ...
    "Metals": [
        ...
        "NMDC-EQ", "HINDZINC-EQ", "NALCO-EQ", "JINDALSTEL-EQ", "MOIL-EQ",
        "APLAPOLLO-EQ", "RATNAMANI-EQ", "JSL-EQ", "WELCORP-EQ", "TINPLATE-EQ",
        "SHYAMMETL-EQ", "MIDHANI-EQ", "GRAVITA-EQ", "SARDAEN-EQ", "ASHAPURMIN-EQ",
        "JTLIND-EQ", "RAMASTEEL-EQ", "MAITHANALL-EQ", "KIOCL-EQ", "IMFA-EQ",
        "GMDCLTD-EQ", "VISHNU-EQ", "SANDUMA-EQ", "VRAJ-EQ", "COALINDIA-EQ", "NILE-EQ"
    ],
    ...
    "FMCG": [
        ...
        "BIKAJI-EQ", "VBL-EQ", "ZOMATO-EQ", "DOMS-EQ",
    ...
    "Power": [
        ...
        "INDIAGRID-EQ", "POWERMECH-EQ", "KEC-EQ", "INOXWIND-EQ", "KALPATPOWR-EQ",
        "SUZLON-EQ", "BHEL-EQ", "THERMAX-EQ", "GEPIL-EQ", "VOLTAMP-EQ",
        "TRIL-EQ", "TDPOWERSYS-EQ", "JYOTISTRUC-EQ", "IWEL-EQ", "ACMESOLAR-EQ"
    ],

    "Capital Goods": [
        "LT-EQ", "SIEMENS-EQ", "ABB-EQ", "BEL-EQ", "BHEL-EQ", "HAL-EQ",
        "CUMMINSIND-EQ", "THERMAX-EQ", "AIAENG-EQ", "SKFINDIA-EQ", "GRINDWELL-EQ",
        "TIMKEN-EQ", "KSB-EQ", "ELGIEQUIP-EQ", "LAKSHMIMACH-EQ", "KIRLOSENG-EQ",
        "GREAVESCOT-EQ", "TRITURBINE-EQ", "VOLTAS-EQ", "BLUESTARCO-EQ", "HAVELLS-EQ",
        "DIXON-EQ", "KAYNES-EQ", "SYRMA-EQ", "AMBER-EQ", "SUZLON-EQ", "CGPOWER-EQ",
        "APARINDS-EQ", "HBLPOWER-EQ", "KEI-EQ", "POLYCAB-EQ", "RRKABEL-EQ",
        ...
        "GMMPFAUDLR-EQ", "ESABINDIA-EQ", "CENTURYEXT-EQ", "SALASAR-EQ", "TITAGARH-EQ",
    ...
    "Oil & Gas": [
        ...
        "AEGISCHEM-EQ", "CHENNPETRO-EQ", "MRPL-EQ", "GULFOILLUB-EQ", "CASTROLIND-EQ",
    ...
    "Chemicals": [
        ...
        "SUMICHEM-EQ", "PIIND-EQ", "DHARAMSI-EQ", "EIDPARRY-EQ", "CHEMPLASTS-EQ",
        "VISHNU-EQ", "IGPL-EQ", "TIRUMALCHM-EQ", "RALLIS-EQ"
    ],

    "Telecom": [
        "BHARTIARTL-EQ", "VODAFONEIDEA-EQ", "INDUSTOWER-EQ", "TATACOMM-EQ",
        "HFCL-EQ", "TEJASNET-EQ", "STLTECH-EQ", "ITI-EQ", "ASTEC-EQ"
    ],

    "Infrastructure": [
        "LT-EQ", "GMRINFRA-EQ", "IRB-EQ", "NBCC-EQ", "RVNL-EQ", "KEC-EQ",
